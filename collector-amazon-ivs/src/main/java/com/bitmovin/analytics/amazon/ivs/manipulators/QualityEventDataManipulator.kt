 ...
 * - videoCodec
 */
internal class QualityEventDataManipulator(
    ...
    override fun manipulate(data: EventData) {
        try {
            ...
            // we use the quality data to track stream quality which
            // represents what's coming from the manifest
            ...
            if (currentQuality != null) {
                // quality.bitrate is the media bitrate which
                // is including video and audio bitrate
            ...
            BitmovinLog.e(
                "QualityDataManipulator",
                "Something went wrong while setting quality event data",
                e,
            )
        }
    }
    ...
    companion object {
        private fun extractCodecInfo(codecs: String): CodecInfo {
            ...
            // try to confirm the reverse case when the first item is audio codec
            // and the second item is video codec
