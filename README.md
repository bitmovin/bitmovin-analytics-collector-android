...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-bitmovin-player:3.20.0'
}
```
...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-media3-exoplayer:3.20.0'
}
```
...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-exoplayer:3.20.0'
}
```
...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-amazon-ivs:3.20.0'
}
```
