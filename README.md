...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-bitmovin-player:3.34.0'
}
```
...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-media3-exoplayer:3.34.0'
}
```
...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-theoplayer:3.34.0'
}
```
