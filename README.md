...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-bitmovin-player:3.12.0'
}
```
...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-media3-exoplayer:3.12.0'
}
```
...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-exoplayer:3.12.0'
}
```
