...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-bitmovin-player:3.35.0'
}
```
...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-media3-exoplayer:3.35.0'
}
```
...
```gradle
dependencies {
    implementation 'com.bitmovin.analytics:collector-theoplayer:3.35.0'
}
```
