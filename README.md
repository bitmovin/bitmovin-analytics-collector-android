...
```
dependencies {
    implementation 'com.bitmovin.analytics:collector-bitmovin-player:1.26.0'
}
```
...
```
dependencies {
    implementation 'com.bitmovin.analytics:collector-bitmovin-player:2.2.0'
}
```
...
```
dependencies {
    implementation 'com.bitmovin.analytics:collector-exoplayer:1.26.0'
}
```
...
```
dependencies {
    implementation 'com.bitmovin.analytics:collector-exoplayer:2.2.0'
}
```
