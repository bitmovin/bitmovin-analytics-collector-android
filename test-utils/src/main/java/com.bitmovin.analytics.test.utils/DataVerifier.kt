...
object DataVerifier {
    ...
    fun verifyAnalyticsConfig(
        ...
        assertThat(eventData.customData61).isEqualTo(analyticsConfig.customData61)
        assertThat(eventData.customData62).isEqualTo(analyticsConfig.customData62)
        assertThat(eventData.customData63).isEqualTo(analyticsConfig.customData63)
        assertThat(eventData.customData64).isEqualTo(analyticsConfig.customData64)
        assertThat(eventData.customData65).isEqualTo(analyticsConfig.customData65)
        assertThat(eventData.customData66).isEqualTo(analyticsConfig.customData66)
        assertThat(eventData.customData67).isEqualTo(analyticsConfig.customData67)
        assertThat(eventData.customData68).isEqualTo(analyticsConfig.customData68)
        assertThat(eventData.customData69).isEqualTo(analyticsConfig.customData69)
        assertThat(eventData.customData70).isEqualTo(analyticsConfig.customData70)
        assertThat(eventData.customData71).isEqualTo(analyticsConfig.customData71)
        assertThat(eventData.customData72).isEqualTo(analyticsConfig.customData72)
        assertThat(eventData.customData73).isEqualTo(analyticsConfig.customData73)
        assertThat(eventData.customData74).isEqualTo(analyticsConfig.customData74)
        assertThat(eventData.customData75).isEqualTo(analyticsConfig.customData75)
        assertThat(eventData.customData76).isEqualTo(analyticsConfig.customData76)
        assertThat(eventData.customData77).isEqualTo(analyticsConfig.customData77)
        assertThat(eventData.customData78).isEqualTo(analyticsConfig.customData78)
        assertThat(eventData.customData79).isEqualTo(analyticsConfig.customData79)
        assertThat(eventData.customData80).isEqualTo(analyticsConfig.customData80)
        assertThat(eventData.customData81).isEqualTo(analyticsConfig.customData81)
        assertThat(eventData.customData82).isEqualTo(analyticsConfig.customData82)
        assertThat(eventData.customData83).isEqualTo(analyticsConfig.customData83)
        assertThat(eventData.customData84).isEqualTo(analyticsConfig.customData84)
        assertThat(eventData.customData85).isEqualTo(analyticsConfig.customData85)
        assertThat(eventData.customData86).isEqualTo(analyticsConfig.customData86)
        assertThat(eventData.customData87).isEqualTo(analyticsConfig.customData87)
        assertThat(eventData.customData88).isEqualTo(analyticsConfig.customData88)
        assertThat(eventData.customData89).isEqualTo(analyticsConfig.customData89)
        assertThat(eventData.customData90).isEqualTo(analyticsConfig.customData90)
        assertThat(eventData.customData91).isEqualTo(analyticsConfig.customData91)
        assertThat(eventData.customData92).isEqualTo(analyticsConfig.customData92)
        assertThat(eventData.customData93).isEqualTo(analyticsConfig.customData93)
        assertThat(eventData.customData94).isEqualTo(analyticsConfig.customData94)
        assertThat(eventData.customData95).isEqualTo(analyticsConfig.customData95)
        assertThat(eventData.customData96).isEqualTo(analyticsConfig.customData96)
        assertThat(eventData.customData97).isEqualTo(analyticsConfig.customData97)
        assertThat(eventData.customData98).isEqualTo(analyticsConfig.customData98)
        assertThat(eventData.customData99).isEqualTo(analyticsConfig.customData99)
        assertThat(eventData.customData100).isEqualTo(analyticsConfig.customData100)
    }
