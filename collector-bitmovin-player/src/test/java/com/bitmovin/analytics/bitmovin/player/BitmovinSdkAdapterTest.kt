...
class BitmovinSdkAdapterTest {
    ...
    fun setup() {
        ...
        adapter = BitmovinSdkAdapter(fakePlayer, Mockito.mock(BitmovinAnalyticsConfig::class.java), Mockito.mock(DeviceInformationEventDataDecorator::class.java), stateMachine)
        adapter.init()
    }
