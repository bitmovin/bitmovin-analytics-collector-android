...
import com.bitmovin.analytics.media3.listeners.AnalyticsEventListener
import com.bitmovin.analytics.media3.listeners.PlayerEventListener
import com.bitmovin.analytics.media3.manipulators.PlaybackEventDataManipulator
import com.bitmovin.analytics.media3.manipulators.QualityEventDataManipulator
...
internal class Media3ExoPlayerAdapter(
    ...
    private val playbackEventDataManipulator = PlaybackEventDataManipulator(player, playbackInfoProvider, metadataProvider, drmInfoProvider, playerStatisticsProvider, meter)
