...
import com.bitmovin.analytics.media3.features.Media3ExoPlayerFeatureFactory
...
@UnstableApi
internal class Media3PlayerCollector(analyticsConfig: AnalyticsConfig, context: Context) :
