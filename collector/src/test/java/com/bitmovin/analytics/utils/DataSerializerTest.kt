...
class DataSerializerTest {
    ...
    fun testSerialize_EventData() {
        ...
        val userAgent = "user-agent-test"
        val userAgentProvider = mockk<UserAgentProvider>()
        every { userAgentProvider.userAgent } returns userAgent
