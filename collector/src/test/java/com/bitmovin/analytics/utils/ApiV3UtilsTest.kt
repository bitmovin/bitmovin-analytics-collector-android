...
class ApiV3UtilsTest {
    ...
    fun test_extractAnalyticsConfig_mapsAllFields() {
        // arrange
        val oldConfig = BitmovinAnalyticsConfig("key").apply {
            ads = false
        ...
        // assert
        val expectedConfig = AnalyticsConfig(
            licenseKey = "key",
    ...
    fun test_extractDefaultMetadata_mapsAllFields() {
        // arrange
        val oldConfig = BitmovinAnalyticsConfig().apply {
        ...
        val expectedCustomData = CustomData(
            customData1 = "customData1",
            customData2 = "customData2",
            customData3 = "customData3",
            customData4 = "customData4",
        ...
        // assert
        val expectedDefaultMetadata = DefaultMetadata(
            customUserId = "customUserId",
    ...
    fun test_extractSourceMetadata_mapsAllFields() {
        ...
        // assert
        val expectedSourceMetadata = SourceMetadata(
            title = "title",
            videoId = "videoId",
            path = "path",
            cdnProvider = "cdnProvider",
    ...
    fun test_mergeCustomData_mergesFieldsCorrectly2() {
        // arrage
        val mainCustomData = createDummyCustomData("test").copy(customData1 = null, customData10 = null, customData30 = null)
        val fallbackCustomData = createDummyCustomData("fallback")
        ...
        // assert
        val expectedCustomData = mainCustomData.copy(customData1 = "fallback1", customData10 = "fallback10", customData30 = "fallback30")
    ...
    companion object {
        fun createDummyCustomData(prefix: String = "customData"): CustomData {
            return CustomData(
                experimentName = prefix + "Experiment", customData1 = prefix + "1", customData2 = prefix + "2", customData3 = prefix + "3", customData4 = prefix + "4", customData5 = prefix + "5", customData6 = prefix + "6", customData7 = prefix + "7", customData8 = prefix + "8", customData9 = prefix + "9", customData10 = prefix + "10",
