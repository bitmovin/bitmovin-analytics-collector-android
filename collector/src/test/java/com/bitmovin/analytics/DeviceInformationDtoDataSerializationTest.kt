...
class DeviceInformationDtoDataSerializationTest {
    ...
    fun testSerializesEventDataDeviceInformationCorrectly() {
        ...
        val data = EventData(config, "1234", DeviceInformation(manufacturer, model, "user-agent", "de", "my.package", 100, 200, DeviceInformation.ScreenOrientation.Undefined), "user-id");
        ...
        assertThat(serialized).doesNotContain("\"screenOrientation\"")
    }
}