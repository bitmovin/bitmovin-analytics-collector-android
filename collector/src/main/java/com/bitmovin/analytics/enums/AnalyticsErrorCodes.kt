...
enum class AnalyticsErrorCodes(val errorCode: ErrorCode) {
    ANALYTICS_QUALITY_CHANGE_THRESHOLD_EXCEEDED(ErrorCode(10000, "ANALYTICS_QUALITY_CHANGE_THRESHOLD_EXCEEDED", ErrorData(additionalData = "There were more than " + Util.ANALYTICS_QUALITY_CHANGE_COUNT_THRESHOLD + " quality changes within 1 hour."), errorSeverity = ErrorSeverity.INFO)),
