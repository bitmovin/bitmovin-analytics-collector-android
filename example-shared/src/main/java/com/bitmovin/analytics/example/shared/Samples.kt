...
object Samples {
    ...
    // IVS example sources
    val IVS_LIVESTREAM1_SOURCE = Sample("liveStream1Source", "https://fcc3ddae59ed.us-west-2.playback.live-video.net/api/video/v1/us-west-2.893648527354.channel.DmumNckWFTqz.m3u8")
    val IVS_LIVESTREAM2_SOURCE = Sample("liveStream2Source", "https://fcc3ddae59ed.us-west-2.playback.live-video.net/api/video/v1/us-west-2.893648527354.channel.XFAcAcypUxQm.m3u8")
    val IVS_VODSTREAM_SOURCE = Sample("ivsVodStreamSource", "https://d6hwdeiig07o4.cloudfront.net/ivs/956482054022/cTo5UpKS07do/2020-07-13T22-54-42.188Z/OgRXMLtq8M11/media/hls/master.m3u8")
    val NONE_EXISTING_STREAM = Sample("invalidLiveStreamSource", "https://fcc3ddae59ed.us-west-2.playback.live-video.net/api/video/v1/us-west-2.893648527354.channel.DmumNckWFTqz_invalid.m3u8")
}
