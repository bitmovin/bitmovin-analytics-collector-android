...
object Samples {
    ...
    val PROGRESSIVE =
        Sample("Progressive", "https://bitmovin-a.akamaihd.net/content/MI201109210084_1/MI201109210084_mpeg-4_hd_high_1080p25_10mbits.mp4")

    val HLS_DRM_WIDEVINE =
        Sample(
            "Hls + Widevine",
    ...
    val HLS_DRM_WIDEVINE_ENCRYPTED =
        Sample(
            "Encrypted Hls + Widevine",
            "https://bitmovin-a.akamaihd.net/content/art-of-motion_drm/m3u8s/11331.m3u8",
            "widevine",
            "https://widevine-proxy.appspot.com/proxy",
        )
    val DASH_DRM_WIDEVINE =
        Sample(
            "Dash + Widevine",
    ...
    val HLS_REDBULL =
        Sample("HLSRedbulll", "https://bitmovin-a.akamaihd.net/content/MI201109210084_1/m3u8s/f08e80da-bf1d-4e3d-8899-f0f6155f6efa.m3u8")
