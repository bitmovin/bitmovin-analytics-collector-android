 ...
 * https://github.com/bitmovin/bitmovin-player-android-samples/blob/main/LoggingKotlin/src/main/java/com/bitmovin/player/samples/logging/EventLogger.kt
 *
