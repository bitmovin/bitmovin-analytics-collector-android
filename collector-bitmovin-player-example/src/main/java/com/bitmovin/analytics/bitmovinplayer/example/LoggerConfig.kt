...
/**
 * Copied over from Player Samples Project
 * https://github.com/bitmovin/bitmovin-player-android-samples/blob/main/LoggingKotlin/src/main/java/com/bitmovin/player/samples/logging/LoggerConfig.kt
 *
...
sealed interface LoggerConfig<T : Event> {
    ...
    data class SourceLoggerConfig(
        ...
        override val errorEvents: List<KClass<out SourceEvent>> =
            listOf(
                SourceEvent.Error::class,
            ),
        override val warningEvents: List<KClass<out SourceEvent>> =
            listOf(
                SourceEvent.Warning::class,
            ),
        override val infoEvents: List<KClass<out SourceEvent>> =
            listOf(
        ...
        override val debugEvents: List<KClass<out SourceEvent>> =
            listOf(
    ...
    data class PlayerLoggerConfig(
        override val logLevel: EventLogger.Level = EventLogger.Level.Info,
        override val tag: String = "BitmovinPlayerDebugging",
        override val errorEvents: List<KClass<out PlayerEvent>> =
            listOf(
                PlayerEvent.Error::class,
            ),
        override val warningEvents: List<KClass<out PlayerEvent>> =
            listOf(
                PlayerEvent.Warning::class,
            ),
        override val infoEvents: List<KClass<out PlayerEvent>> =
            listOf(
        ...
        override val debugEvents: List<KClass<out Event>> =
            listOf(
    ...
    data class OfflineLoggerConfig(
        ...
        override val errorEvents: List<KClass<out OfflineEvent>> =
            listOf(
                OfflineEvent.Error::class,
            ),
        override val warningEvents: List<KClass<out OfflineEvent>> =
            listOf(
                OfflineEvent.Warning::class,
            ),
        override val infoEvents: List<KClass<out OfflineEvent>> =
            listOf(
