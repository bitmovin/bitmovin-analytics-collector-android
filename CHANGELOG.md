...
- [Internal] Separated BitmovinPlayer collector projects and example applications
    - rename all occurrences of `bitmovinanalyticsexample` to `bitmovinplayerexample`
